...
interface TransactionsListProps {
  ...
  onCheckoutClick?: (transaction: CheckoutTransaction) => void;
  onInventoryClick?: (transaction: InventoryTransaction) => void;
}
                ...
                if (
                  ...
                  return (
                    <GeneralCheckoutCard
                      ...
                      onClick={
                        onCheckoutClick
                          ? () => onCheckoutClick(checkoutTransaction)
                          : undefined
                      }
                    />
                  );
                  ...
                  return (
                    <InventoryCard
                      ...
                      onClick={
                        onInventoryClick
                          ? () => onInventoryClick(inventoryTransaction)
                          : undefined
                      }
                    />
                  );
