...
const originalData: InventoryItem[] = [
    { id: 1, name: 'Item 1', type: 'General', quantity: 10, threshold: 2, description: 'Desc 1', category: 'Cat 1', status: 'Active' },
    { id: 2, name: 'Item 2', type: 'Welcome Basket', quantity: 5, threshold: 2, description: 'Desc 2', category: 'Cat 2', status: 'Active' },
];
